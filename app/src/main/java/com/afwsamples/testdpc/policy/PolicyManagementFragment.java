...
public class PolicyManagementFragment extends BaseSearchablePolicyPreferenceFragment implements
    ...
    private static final String REISI_SET_NEARBY_APP_STREAMING_KEY = "reisi_set_nearby_app_streaming";
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        findPreference(REISI_SET_NEARBY_APP_STREAMING_KEY).setOnPreferenceClickListener(this);
